...
<details>
<summary>📥 Click to download</summary>
...
|:---------:|:-----------:|
| 🎵 **Аудио** | Уникальные музыкальные композиции |
| 🔑 **Управление** | Биндинг клавиш, кастомизация тотема (превращение в куклу!) |
| 📷 **Камера** | Приближение и отдаление объектов |
| 🗣 **Общение** | SimpleVoiceChat и EmoteCraft для живого общения |
| 💬 **Чат** | Chat Patches, Symbol Chat и VoiceMessages — улучшенный чат |
...
| Category | Features |
|:--------:|:--------:|
| 🎵 **Audio** | Unique music tracks |
| 🔑 **Controls** | Key binding, custom totem skins (turns into a doll!) |
| 📷 **Camera** | Zoom in/out functionality |
| 🗣 **Communication** | SimpleVoiceChat, EmoteCraft |
...
| Server Favorites | Multiple Languages | Resource Pack Manager | Hotkey Settings |
|:--:|:--:|:--:|:--:|
| ![Favorites](https://cdn.modrinth.com/data/cached_images/7b78928d7d3c9654665c22b22aae4bcbcb5e3262.gif) | ![Languages](https://cdn.modrinth.com/data/cached_images/f4700931fa45dc6e7e08f555596f8d5309e5bf3f.gif) | ![Resource Packs](https://cdn.modrinth.com/data/cached_images/0598858e60b6aa6efff78f763b7bd0ec10e07cf6.gif) | ![Hotkeys](https://cdn.modrinth.com/data/cached_images/e20572639d3cf539dfcd78191ff7e6bdd36ac99b.gif) |
...
1. Download the **XMCL Launcher** from the link above
2. Open the launcher and import the modpack
3. For detailed instructions, visit our [Wiki](https://romixerx.ru/build)
4. Launch and enjoy! 🎉
...
If you enjoy this modpack, please consider:
- ⭐ Starring this repository
- 📢 Sharing with friends
- 🎥 Creating videos about the modpack
